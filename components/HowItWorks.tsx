    ...
    cards: [
      {
        ...
        title: 'MON ASSISTANT COPILO',
        tag: '@Copilo_TaxiBot',
        desc: 'Ton assistant vocal personnalisé. Parle-lui en push-to-talk depuis la route — courses, recettes, calendrier.',
        time: '2 min',
      },
      {
        id: 'group',
    ...
    cards: [
      {
        ...
        glow: 'rgba(29,92,255,0.12)',
        border: 'rgba(29,92,255,0.28)',
        title: 'MY COPILO ASSISTANT',
        tag: '@Copilo_TaxiBot',
        desc: 'Your personal voice assistant. Talk to it push-to-talk on the road — rides, revenue, calendar.',
        time: '2 min',
      },
      {
        id: 'group',
