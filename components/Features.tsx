...
const T: { fr: { label: string; title: string; sub: string; items: Feature[] }; en: { label: string; title: string; sub: string; items: Feature[] } } = {
  fr: {
    ...
    items: [
      ...
      { iconKey: 'users',    color: '#d97706', glow: 'rgba(217,119,6,0.15)',  title: 'Courses & Bons de transport', desc: 'Les courses que tu ne peux pas prendre partent automatiquement dans ton groupe Copilo 🚕. Envoie la photo d\'un BT, Copilo le lit et le lie à la course tout seul. Fini les trous dans ta caisse.' },
  ...
  en: {
    ...
    items: [
      ...
      { iconKey: 'users',    color: '#d97706', glow: 'rgba(217,119,6,0.15)',  title: 'Rides & Transport Receipts', desc: 'Rides you can\'t take are automatically dispatched to your Copilo group 🚕. Snap a receipt photo, Copilo reads and links it to the ride. No more lost revenue.' },
