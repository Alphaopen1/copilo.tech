...
const T: { fr: { label: string; title: string; sub: string; items: Feature[] }; en: { label: string; title: string; sub: string; items: Feature[] } } = {
  fr: {
    ...
    items: [
      { iconKey: 'mic',      color: '#1d5cff', glow: 'rgba(29,92,255,0.15)',  title: 'Commande vocale',          desc: 'Parle naturellement en conduisant. Copilo comprend le contexte, les corrections, et les nuances.' },
      ...
      { iconKey: 'euro',     color: '#059669', glow: 'rgba(5,150,105,0.15)',  title: 'CA CPAM automatique',       desc: 'Calcul en temps réel selon la convention nationale. Péages appris automatiquement.' },
      { iconKey: 'users',    color: '#d97706', glow: 'rgba(217,119,6,0.15)',  title: 'Détection doublets',        desc: 'Deux clients, même créneau, même direction ? Copilo propose la fusion avec abatement -23%.' },
  ...
  en: {
    ...
    items: [
      { iconKey: 'mic',      color: '#1d5cff', glow: 'rgba(29,92,255,0.15)',  title: 'Voice commands',           desc: 'Speak naturally while driving. Copilo understands context, corrections, and nuance.' },
      ...
      { iconKey: 'euro',     color: '#059669', glow: 'rgba(5,150,105,0.15)',  title: 'Automatic revenue',        desc: 'Real-time CPAM calculation per national convention. Tolls learned automatically.' },
      { iconKey: 'users',    color: '#d97706', glow: 'rgba(217,119,6,0.15)',  title: 'Ride sharing detection',   desc: 'Two clients, same slot, same direction? Copilo proposes merge with -23% CPAM abatement.' },
